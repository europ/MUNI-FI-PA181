...
\begin{center}
    ...
    %JIRKA: Frontend je implementován za použití Javascript frameworku ReactJS s využitím komponent Material UI. UI klade důraz na jednoduchost, přehlednost a responzivitu, aby bylo možné aplikaci snadno využívat i na mobilních telefonech. Frontend komunikuje s backendem přes REST api, kde struktura testových otázek je zasílána ve formátu json. Na frontendu i backendu probíhá validace vstupních dat. K dispozici je přihlášení pro administrátora, který má možnost mazat vložené testy.
    \TODO
\end{center}
...
\begin{figure}[H]
    \centering
    \fcolorbox{imageBorderColor}{white}{\includegraphics[scale=0.225]{img/application/example1.png}}
...
\begin{figure}[H]
    \centering
    \fcolorbox{imageBorderColor}{white}{\includegraphics[scale=0.225]{img/application/example2.png}}
...
\begin{figure}[H]
    \centering
    \fcolorbox{imageBorderColor}{white}{\includegraphics[scale=0.225]{img/application/example3.png}}
...
\begin{figure}[H]
    \centering
    \fcolorbox{imageBorderColor}{white}{\includegraphics[scale=0.225]{img/application/example4.png}}
    \caption{Example 4 - login.}
    \label{fig:example4}
\end{figure}

\begin{figure}[H]
    \centering
    \fcolorbox{imageBorderColor}{white}{\includegraphics[scale=0.225]{img/application/example5.png}}
    \caption{Example 5 - add a new test.}
    \label{fig:example5}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Example 6 - language selection.}
    \label{fig:example6}
\end{figure}
