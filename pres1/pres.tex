...
\section[Application]{Application}
  ...
  \subsection{Examples}
    ...
    \begin{frame}{Example 1}
      \begin{figure}
        \fcolorbox{imageBorderColor}{white}{\includegraphics[width=0.75\textwidth,height=0.75\textheight,keepaspectratio]{img/application/example1.png}}
    ...
    \begin{frame}{Example 2}
      \begin{figure}
        \fcolorbox{imageBorderColor}{white}{\includegraphics[width=0.8\textwidth,height=0.8\textheight,keepaspectratio]{img/application/example2.png}}
    ...
    \begin{frame}{Example 3}
      \begin{figure}
        \fcolorbox{imageBorderColor}{white}{\includegraphics[width=0.8\textwidth,height=0.8\textheight,keepaspectratio]{img/application/example3.png}}
    ...
    \begin{frame}{Example 4}
      \begin{figure}
        \fcolorbox{imageBorderColor}{white}{\includegraphics[width=0.8\textwidth,height=0.8\textheight,keepaspectratio]{img/application/example9.png}}
    ...
    \begin{frame}{Example 6}
      \begin{figure}
        \fcolorbox{imageBorderColor}{white}{\includegraphics[width=0.75\textwidth,height=0.75\textheight,keepaspectratio]{img/application/example5.png}}
